	...
	: QWidget(p)
{
	...
	m_roleName->setText(QString::fromLocal8Bit("玩家的编号"));
	m_moreInfo->setText(QString::fromLocal8Bit("更多的信息..."));
	...
	m_inMsgLabel->setText(QString::fromLocal8Bit("你的好友添加请求已经发送成功，正在等待对方确认"));
